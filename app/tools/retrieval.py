...
SAMPLE_MOF_DB = [
    ...
    },
    {
        ...
        "properties": {
            "surface_area_m2g": 1187,
            "pore_volume_cm3g": 0.44
        }
    },
    {
        "mof_name": "MIL-101",
        ...
        "properties": {
            "surface_area_m2g": 4100,
            "pore_volume_cm3g": 2.15
        }
    }
]
...
def search_mof_db(query_string: str) -> Dict[str, Any]:
    ...
    for mof in SAMPLE_MOF_DB:
        ...
        if (query_lower in mof["mof_name"].lower() or
            query_lower in mof["formula"].lower() or
            query_lower in mof["description"].lower() or
            any(query_lower in tag.lower() for tag in mof["tags"])):
